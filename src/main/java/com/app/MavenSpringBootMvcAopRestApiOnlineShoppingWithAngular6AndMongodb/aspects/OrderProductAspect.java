...
public class OrderProductAspect {
	...
	private Logger logger = Logger.getLogger(OrderProductAspect.class);
	
	private long startTime;
	
	private long endTime;
	
	@Pointcut("execution(* com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithAngular6AndMongodb.dao.IOrderProductDAO.*(..))")
	...
	@Before("execution(public * com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithAngular6AndMongodb.dao.IOrderProductDAO.create(..))")
	...
	@After("execution(public * com.app.MavenSpringBootMvcAopRestApiOnlineShoppingWithAngular6AndMongodb.dao.IOrderProductDAO.create(..))")
